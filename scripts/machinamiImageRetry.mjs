...
const TARGETS = [
  { id: 'suzaka', name: '須坂', prefecture: '長野県', words: ['須坂', '長野'],
    queries: ['須坂 蔵の町並み', '須坂市 田中本家', 'Suzaka Nagano townscape', '須坂 商家'] },
  { id: 'tebajima', name: '出羽島', prefecture: '徳島県', words: ['出羽島', '牟岐', '徳島'],
    queries: ['出羽島 集落', '出羽島 町並み', 'Tebajima Mugi', '出羽島 ミセ造り'] },
  { id: 'kanegasaki', name: '金ケ崎 城内諏訪小路', prefecture: '岩手県', words: ['金ケ崎', '城内', '諏訪小路', '岩手'],
    queries: ['金ケ崎町 城内諏訪小路', '金ケ崎要害', 'Kanegasaki Iwate machinami', '金ケ崎町 武家住宅'] },
  { id: 'murata-miyagi', name: '村田の蔵の町', prefecture: '宮城県', words: ['村田', '宮城'],
    queries: ['村田町 蔵の町並み', '村田町 商家', 'Murata Miyagi townscape', '村田町 店蔵'] },
];
...
fs.writeFileSync('logs/machinami_retry.json', JSON.stringify(report, null, 2));
console.log(`\n候補 ${report.length}件 → logs/machinami_retry.json`);
