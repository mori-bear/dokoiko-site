...
const TARGETS = [
  { id: 'kasumi-kaigan', name: '香住海岸', prefecture: '兵庫県', words: ['香住', '但馬', '香美', '兵庫'],
    queries: ['但馬御火浦', '香住海岸 岩', '今子浦 香美町', 'Kasumi coast Hyogo'] },
  { id: 'sandankyo', name: '三段峡', prefecture: '広島県', words: ['三段峡', '安芸太田', '広島'],
    queries: ['三段峡 三段滝', '三段峡 黒淵', 'Sandankyo gorge', '三段峡 猿飛'] },
];
...
fs.writeFileSync('logs/keikan_retry.json', JSON.stringify(report, null, 2));
console.log(`\n候補 ${report.length}件 → logs/keikan_retry.json`);
