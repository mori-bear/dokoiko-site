...
const CANDIDATES = [
  // ── 大阪の絶景（1回目は箕面大滝が勝尾寺2.1km、岩湧山が画像で落ちた）──
  ['nose-ohtaki',   '能勢の大ケヤキ', '大阪府', '能勢町',   ['野間の大ケヤキ'],     ['野間の大ケヤキ']],
  ['kanku-observ',  '関空展望ホール', '大阪府', '泉佐野市', ['関西国際空港'],       ['スカイビュー']],
  ['hoshida',       'ほしだ園地',     '大阪府', '交野市',   ['星のブランコ', 'ほしだ園地'], ['星のブランコ']],
  // ── 長崎の絶景 ──
  ['tsuzura',       'つづら棚田',     '長崎県', '雲仙市',   ['鬼木棚田', 'つづら棚田'], ['鬼木棚田']],
  ['iojima-nagasaki','伊王島',        '長崎県', '長崎市',   ['伊王島'],             ['伊王島']],
  ['nomozaki',      '野母崎',         '長崎県', '長崎市',   ['野母崎'],             ['野母崎']],
  // ── 千葉の温泉 ──
  ['kominato-onsen','小湊温泉',       '千葉県', '鴨川市',   ['小湊温泉'],           ['小湊温泉']],
  ['tateyama-onsen','館山温泉',       '千葉県', '館山市',   ['館山温泉'],           ['館山温泉']],
  // ── 滋賀の温泉 ──
  ['nagahama-onsen','須賀谷',         '滋賀県', '長浜市',   ['須賀谷温泉'],         ['須賀谷温泉']],
  ['hino-onsen',    '南比良温泉',     '滋賀県', '大津市',   ['比良山地'],           ['比良とぴあ']],
  // ── 徳島・愛知・岡山・栃木の絶景 ──
  ['ochiai-shuraku','落合集落',       '徳島県', '三好市',   ['落合集落'],           ['落合集落']],
  ['shitara',       '阿寺の七滝',     '愛知県', '新城市',   ['阿寺の七滝'],         ['阿寺の七滝']],
  ['gokei-okayama', '豪渓',           '岡山県', '総社市',   ['豪渓'],               ['豪渓']],
  ['kirifuri',      '霧降滝',         '栃木県', '日光市',   ['霧降ノ滝'],           ['霧降の滝']],
];
...
fs.writeFileSync('logs/gap_candidates3.json', JSON.stringify(out, null, 1));
console.log(`\n合格 ${passed.length} / ${out.length} 件 → logs/gap_candidates3.json`);
