...
const TARGETS = [
  { id: 'higashiyama-aizu', name: '東山温泉', prefecture: '福島県', words: ['東山', '会津', '若松'],
    queries: ['東山温泉 会津', 'Higashiyama Onsen Aizu', '東山温泉 湯川', '会津東山温泉'] },
];
...
fs.writeFileSync('logs/major_retry2.json', JSON.stringify(report, null, 2));
console.log(`\n候補 ${report.length}件 → logs/major_retry2.json`);
