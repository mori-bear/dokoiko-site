...
const TARGETS = [
  { id: 'awara', name: 'あわら温泉', prefecture: '福井県', words: ['あわら', '芦原', '福井'],
    queries: ['芦原温泉 あわら市', 'あわら温泉', 'Awara Onsen', 'セントピアあわら 芦湯'] },
];
...
fs.writeFileSync('logs/awara_retry.json', JSON.stringify(report, null, 2));
console.log(`\n候補 ${report.length}件 → logs/awara_retry.json`);
