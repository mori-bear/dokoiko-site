...
// 出発地セレクトの表示グループ（主要都市を最上部に別枠、以下地方順）
export const DEPARTURE_GROUPS = [
  { label: '主要都市',     cities: ['東京', '大阪', '名古屋', '福岡', '札幌', '仙台', '広島'] },
  { label: '北海道・東北', cities: ['札幌', '函館', '旭川', '釧路', '帯広', '北見', '青森', '八戸', '盛岡', '仙台', '秋田', '山形', '福島'] },
  { label: '関東',         cities: ['東京', '横浜', '千葉', '大宮', '宇都宮', '水戸', '前橋', '高崎'] },
  { label: '中部',         cities: ['新潟', '長野', '甲府', '静岡', '浜松', '名古屋', '岐阜', '富山', '金沢', '福井'] },
  { label: '近畿',         cities: ['大阪', '京都', '神戸', '姫路', '奈良', '和歌山', '白浜', '田辺', '新宮', '串本'] },
  { label: '中国',         cities: ['広島', '福山', '岡山', '倉敷', '鳥取', '米子', '松江', '山口', '下関'] },
  { label: '四国',         cities: ['高松', '徳島', '松山', '高知'] },
  { label: '九州・沖縄',   cities: ['福岡', '佐賀', '長崎', '熊本', '大分', '別府', '宮崎', '鹿児島', '那覇', '石垣', '宮古'] },
];
